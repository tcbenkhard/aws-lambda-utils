...
export abstract class ApiGatewayHandler<Request, Response> {
    ...
    protected abstract parseEvent(event: APIGatewayProxyEvent, Context: Context): Request | Promise<Request>;
    protected abstract handleRequest(request: Request): Response | Promise<Response>
